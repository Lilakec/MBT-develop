...
public class automation extends ExecutionContext implements tbClient {
    ...
    public void e_backToMainPage() {
        if (byElementIsExist(By.id("com.baidu.tieba:id/forum_head_image"))) {
            swipeLeft();
        } else {
            driver.findElementById("com.baidu.tieba:id/widget_navi_back_button").click();
        }
    ...
    public void e_goToPbPage() {
        ...
        while(!byElementIsExist(By.id("com.baidu.tieba:id/thread_info_commont_num"))) {
            swipeUp();
        }
    ...
    public void v_pbPage() {
        Assert.assertTrue(driver.findElementById("com.baidu.tieba:id/tv_pb_title").isDisplayed());
    }
    ...
    public void v_frsPage() {
        Assert.assertTrue(driver.findElementById("com.baidu.tieba:id/forum_name").isDisplayed());
    }
    ...
    public void v_showOwnerReply() {
        ...
        Assert.assertEquals(driver.findElementById("com.baidu.tieba:id/floor_owner_reply").getAttribute("selected"),"true");
    }
